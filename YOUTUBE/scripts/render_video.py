...
def create_scene_video(image_path, audio_path, srt_path, output_path):
    ...
    cmd = [
        ...
        "-vf", f"scale=1920:1080:force_original_aspect_ratio=decrease,pad=1920:1080:(ow-iw)/2:(oh-ih)/2,subtitles='{safe_srt_path}':force_style='FontSize=24,PrimaryColour=&H00FFFFFF,OutlineColour=&H00000000,BorderStyle=1,Outline=2,Shadow=1,Alignment=2,MarginV=30'",
...
def main():
    ...
    for lang in languages:
        ...
        output_final = os.path.join(EXPORT_DIR, f"longform_{lang}_preview_with_subs.mp4")
        temp_files = []
