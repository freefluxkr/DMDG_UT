...
orig=pd.read_csv( "../data/bc_card.txt",sep='\t', encoding='cp949',header=None)
...
card_data = card_data.rename(columns={'MEGA_CTY_NM': '시도명','CTY_RGN_NM': '시군구명','CSTMR_MEGA_CTY_NM': '거주지 시도명','CSTMR_CTY_RGN_NM': '거주지 시군구명','TP_BUZ_NM': '업종 소분류명','SEX_CTGO_CD': '성별','AMT': '이용 금액'})
